...
const Hero = () => {
    return (
        <div className="hero min-h-[calc(100vh-116px)] relative">
            <div className="hero-content text-center">
                <div className="w-full md:w-4/5 lg:w-2/3">
                    <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold">Welcome to <span className="font-bold bg-gradient-to-r from-primary via-blue-500 to-secondary text-transparent bg-clip-text animate-gradient">ByteBlaze</span></h1>
